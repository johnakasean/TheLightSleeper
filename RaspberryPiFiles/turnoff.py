...
#this file, compared to lowlevel has a brightness of 0 which will switch the lights off in the code.

# LED configuration.
LED_CHANNEL    = 0
LED_COUNT      = 200        # How many LEDs to light.
...
try:
	...
	while True:
		...
		# Delay for a small period of time.
		 #this activates for this long until the alarm is reset by the user, so the light doesnt switch back no
